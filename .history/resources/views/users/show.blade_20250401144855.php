<x-app-layout>
    ...
    <div class="relative h-64 bg-blue-500">
        ...
        <svg class="absolute bottom-0 left-0 w-full h-24" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
          <path fill="blue-500" fill-opacity="1" d="M0,224L48,213.3C96,203,192,181,288,165.3C384,149,480,139,576,144C672,149,768,171,864,186.7C960,203,1056,213,1152,208C1248,203,1344,181,1392,170.7L1440,160V320H0Z"></path>
          <path fill="blue-500" fill-opacity="1" d="M0,288L48,266.7C96,245,192,203,288,181.3C384,160,480,160,576,181.3C672,203,768,245,864,256C960,267,1056,245,1152,229.3C1248,213,1344,203,1392,197.3L1440,192V320H0Z"></path>
          <path fill="blue-500" fill-opacity="1" d="M0,320L48,288C96,256,192,192,288,165.3C384,139,480,149,576,165.3C672,181,768,203,864,224C960,245,1056,267,1152,256C1248,245,1344,203,1392,181.3L1440,160V320H0Z"></path>
        </svg>
      </div>
</x-app-layout>