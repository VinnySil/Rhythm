<x-app-layout>
    ...
    <div id="container" class="text-white text-center max-w-lg mx-auto my-10">
        ...
        <div id="data-container" class="text-start p-4 mt-8">
            ...
            <div class="border-b-pink-200 border-b-2 p-2"><input type="text" name="email" id="email" value={{old('email', $user->name)}}" class="bg-slate-900 border-none focus:outline-none focus:border-transparent focus:ring-0 w-full"></div>
        </div>
    </div>
</x-app-layout>