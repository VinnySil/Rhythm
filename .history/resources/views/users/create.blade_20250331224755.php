<x-app-layout>
    <div class="w-2/4 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg mt-5 m-auto justify-center">
        <h1 class="dark:text-gray-400 text-2xl p-4">Crear nuevo usuario</h1>
        <form method="POST" enctype="multipart/form-data" id="createForm" action="{{ route('users.store') }}" class="p-4 w-2/3">
            @csrf    
            <!-- Name -->
            <div>
