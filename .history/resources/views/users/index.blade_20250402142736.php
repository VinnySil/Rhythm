<x-app-layout>
    ...
    <x-modal name="miModal">
        <div class="p-6">
            <h2 class="text-lg font-bold text-gray-900 dark:text-gray-100">Título del Modal</h2>
            <p class="text-gray-600 dark:text-gray-400">Este es un modal reutilizable de Laravel Breeze.</p>
    ...
    <button 
        x-data="" 
        x-on:click.prevent="$dispatch('open-modal', 'miModal')" 
