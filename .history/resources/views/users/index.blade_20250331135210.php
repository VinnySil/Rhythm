<x-app-layout>
    <div class="p-16">
        <div class="text-white mb-10 flex justify-between">             
            ...
            <div id="searcher-container" class="flex bg-slate-800 rounded-2xl px-4 justify-center items-center">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                </svg>
                <input type="text" name="searcher" id="searcher" class="bg-slate-800 border-none">
            </div>
        </div>
        <x-table
