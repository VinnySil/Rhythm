<x-app-layout>
    <div class="w-2/4 p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg mt-5 m-auto text-center max-w-2xl">
        ...
        <form method="POST" enctype="multipart/form-data" id="createForm" action="{{ route('users.store') }}" class="sm:p-4 sm:w-2/3 m-auto">
            @csrf    
            <!-- Name -->
            <div>
            ...
            <div class="mt-4 flex justify-center">
                <select name="rol" id="role" class="bg-gray-700 border-gray-700 text-gray-300 rounded">
            ...
            <div class="flex items-center justify-center mt-4 w-full bg-[#FF73A6]">    
                <x-primary-button class="w-full flex justify-center bg-[#FF73A6]">
                    {{ __('Crear') }}
                </x-primary-button>
            </div>
        </form>
