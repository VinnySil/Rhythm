    ...
    <div class="p-16">
        <div class="text-white mb-10 flex justify-between">             
            ...
            <form id="searcher-container" class="flex bg-slate-800 rounded-2xl px-4 justify-center items-center">
                ...
                {{-- <input type="text" placeholder="Buscar..." name="searcher" id="searcher" class="bg-slate-800 border-none focus:outline-none"> --}}
                <input type="text" placeholder="Buscar..." class="bg-slate-800 text-white border border-gray-600 rounded-lg p-3 w-full focus:ring-0 focus:outline-none"/>
