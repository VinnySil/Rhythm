    ...
    <div class="p-16">
        <div class="text-white mb-10 flex justify-between">             
            ...
            <form method="GET" action={{ route('users.index')}} id="searcher-container" class="flex bg-slate-800 rounded-2xl px-4 justify-center items-center">
                ...
                <input type="text" placeholder="Buscar..." name="searcher" id="searcher" :value="old('searcher')" class="bg-slate-800 border-none focus:outline-none focus:border-transparent focus:ring-0">
