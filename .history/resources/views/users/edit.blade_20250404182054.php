        ...
        <form method="POST" enctype="multipart/form-data" action={{ route('users.update', $user)}} method="POST" id="edit-form" class="md:py-4 m-auto md:flex md:flex-col md:items-center">
            ...
            <div id="main-container" class="md:flex grid gap-10">
                <div id="photo-container" class="justify-center p-4 flex md:justify-center md:items-center cursor-pointer">
                    <img src={{asset('build/'.$user->photo)}} alt={{$user->photo}} class="w-40 md:w-40 md:h-40 border-pink-200 rounded-full border-2">
                </div>
                                <!--Profile photo-->
                                <div class="mt-4 flex justify-center p-3">
                                    <img src={{asset('images/product_photos/default.png')}} id="product_photo" alt="avatar" class="w-24 h-24 cursor-pointer">
