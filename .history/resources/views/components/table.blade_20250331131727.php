        ...
        @forelse ($items as $item)
            <tr class="border-b-2">
                <td class="flex px-4 py-4 justify-center">
                    <a href="" class="w-10 hover:scale-105"><img src="{{asset('cruds/consulta.png')}}" alt="consultar usuario"></a>
                    <a href="" class="w-10 hover:scale-105"><img src="{{asset('cruds/modificar.png')}}" alt="modificar usuario"></a>
                ...
                @foreach ($fields as $field)
                    ...
                    @endif
                @endforeach
                <td class="px-4 py-4 text-white text-center">{{ $item->formatted_date('created_at') }}</td>
                <td class="px-4 py-4 text-white text-center">{{ $item->formatted_date('updated_at') }}</td>
            </tr>
        @empty
            <tr>
